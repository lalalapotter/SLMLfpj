...
pathImageNet = '/Users/zhangcengguang/Desktop/slml/MatchingNetworks-master/miniImagenet/images/'
pathminiImageNet = '/Users/zhangcengguang/Desktop/slml/MatchingNetworks-master/miniImagenet/'
...
for filename in filesCSVSachinRavi:
    with open(filename) as csvfile:
        ...
        for c in tqdm(images.keys()): # Iterate over all the classes
            ...
            # selected_images = np.array(index_sorted)[np.array(index_sorted) - 1]
            # for i in np.arange(len(selected_images)):
                # read file and resize to 84x84x3
            for each in lst_files:
